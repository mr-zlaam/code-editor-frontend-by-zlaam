...
import SendMeVerificationTokenButton from "./components/sendMeVerificationTokenButton";

export default function SendMeVerificationTokenPage() {
  return (
